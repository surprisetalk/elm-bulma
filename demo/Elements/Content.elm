...
import Html exposing ( Html, br, code, h1, h2, hr, li, p, img, strong, small, text, ul)
import Page
...
view =
  let
    ...
    innerContent = [ h1 [] [ text "Hello World"]
    ...
    body = content Standard []
           [ p [] [ text "This content class can be used in any context where you just want to (or can only) write some "
                  , strong [] [ text "text. " ]
