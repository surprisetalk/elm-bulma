...
import Html exposing ( Html, br, code, h1, h2, hr, i, li, p, img, strong, small, span, text, ul)
...
view =
  let
    title = "Icon"
    subtitle = "Bulma is compatible with all icon font libraries: Font Awesome 5, Font Awesome 4, Material Design Icons, Open Iconic, Ionicons etc."
