  ...
  = navbar navbarModifiers []
    ...
    , navbarMenu False []
      ...
      , navbarEnd [] 
        [ navbarItem False []
          [ fieldGroup Right []
            [ controlButton { buttonModifiers | color = Info    } [] [] [ icon Normal [] [ Icon.twitter  ], span [] [ text "Tweet"    ] ]
            , controlButton { buttonModifiers | color = Primary } [] [] [ icon Normal [] [ Icon.download ], span [] [ text "Download" ] ]
            ]
          ]
        ]
      ]
      ...
      , demoArticle "Components"
        ...
        , demoSection "Tabs" []
          [ tabs { tabsModifiers | style = Boxed } [] []
            [ tab True  [] [ a [] [ icon Normal [] [ Icon.image      ], text "Pictures"  ] ]
            , tab False [] [ a [] [ icon Normal [] [ Icon.music      ], text "Music"     ] ]
            , tab False [] [ a [] [ icon Normal [] [ Icon.film       ], text "Videos"    ] ]
            , tab False [] [ a [] [ icon Normal [] [ Icon.file_pdf_o ], text "Documents" ] ]
            ]
          ]
